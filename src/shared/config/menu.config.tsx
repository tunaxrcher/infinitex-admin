    ...
    children: [
      {
        title: 'General Pages',
        children: [
          { title: 'Integrations', icon: Plug, path: '/test1' },
          {
            title: 'Notifications',
            icon: Bell,
            path: '/test1',
          },
          { title: 'API Keys', icon: Key, path: '/test1' },
          { title: 'Appearance', icon: Eye, path: '/test1' },
          {
            title: 'Invite a Friend',
            icon: UserCheck,
            path: '/test1',
          },
          { title: 'Activity', icon: LifeBuoy, path: '/test1' },
          { title: 'Brand', icon: CheckCircle },
          { title: 'Get Paid', icon: Euro },
        ],
      },
      {
        title: 'Other pages',
        ...
        children: [
          {
            children: [
              { title: 'Home', path: '/' },
              {
                title: 'รายงานสินเชื่อ/เปิดสินเชื่อ',
                path: '/loan/product-list',
              },
              {
                title: 'รายงานรายรับ/รายจ่าย',
