...
import { MENU_SIDEBAR_MAIN } from '@src/shared/config/layout-30.config';
...
import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuSeparator, DropdownMenuSub, DropdownMenuSubContent, DropdownMenuSubTrigger, DropdownMenuTrigger } from '@src/shared/components/ui/dropdown-menu';
import { Avatar, AvatarFallback, AvatarImage, AvatarIndicator, AvatarStatus } from '@src/shared/components/ui/avatar';
