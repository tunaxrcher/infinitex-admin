import { MENU_MEGA } from '@src/shared/config/layout-1.config';
...
import { MegaMenuSubAccount } from '@src/shared/components/layouts/layout-1/shared/mega-menu/mega-menu-sub-account';
import { MegaMenuSubAuth } from '@src/shared/components/layouts/layout-1/shared/mega-menu/mega-menu-sub-auth';
import { MegaMenuSubNetwork } from '@src/shared/components/layouts/layout-1/shared/mega-menu/mega-menu-sub-network';
import { MegaMenuSubProfiles } from '@src/shared/components/layouts/layout-1/shared/mega-menu/mega-menu-sub-profiles';
import { MegaMenuSubStore } from '@src/shared/components/layouts/layout-1/shared/mega-menu/mega-menu-sub-store';
