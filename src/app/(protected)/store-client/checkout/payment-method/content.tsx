...
import { Order } from '@src/app/(protected)/store-client/checkout/shipping-info/components/order';
import { Payment } from '@src/app/(protected)/store-client/checkout/payment-method/components/payment';
