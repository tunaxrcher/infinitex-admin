...
import { Info } from '@src/app/(protected)/store-client/checkout/order-placed/components/info';
import { Payment } from '@src/app/(protected)/store-client/checkout/order-placed/components/payment';
import { Order } from '@src/app/(protected)/store-client/checkout/order-summary/components/order';
