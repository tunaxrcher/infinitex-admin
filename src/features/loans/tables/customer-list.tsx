...
export type CustomerListDisplaySheet =
  | 'customerDetails'
  | 'createCustomer'
  | 'editCustomer';
...
export function CustomerListTable({
  ...
  const [customerFormMode, setCustomerFormMode] = useState<'new' | 'edit'>(
    'new',
  );
  ...
  const columns = useMemo<ColumnDef<IData>[]>(
    () => [
      ...
      },
      {
        ...
        cell: (info) => {
          const customerInfo = info.row.getValue(
            'customerInfo',
          ) as IData['customerInfo'];
